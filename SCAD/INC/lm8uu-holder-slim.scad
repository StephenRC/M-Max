...
lm8uu_holder_width = body_width;
lm8uu_holder_length = body_length;
lm8uu_holder_height = body_height;
lm8uu_support_thickness = body_wall_thickness;
lm8uu_holder_gap=5;
lm8uu_diameter = LM8UU_dia;
...
module lm8uu_bearing_holder(with_mountplate=false) {
	translate([body_width/2,body_length/2,0])
	rotate([0,0,0])
	lm8uu_holder(with_mountplate);
}
...
module lm8uu_mounting_cutout()
{
  ...
  #translate([body_width/2,body_length/2,(LM8UU_dia/2)+body_wall_thickness])
	rotate([90,0,0])
